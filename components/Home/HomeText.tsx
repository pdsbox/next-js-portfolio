    ...
    return (
        <article className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p className="mb-9 leading-relaxed text-neutral-600">
                ...
                각자의 방식대로 각자의 의견을 나누다보면,<br />
                매우 다양하고 흥미로운 아이디어들을 발견합니다.<br />
                이것을 구체화시키고 적용하면서 문제를 해결하다보면,<br />
                '또 경험하고 싶다, 더 다양한 문제를 해결하고 싶다.'<br />
                성취감과 동기부여가 생깁니다.
            </p>
            <Link href="/projects" className="inline-flex text-green-100 text-base bg-neutral-400 border-0 py-2 px-6 focus:outline-none hover:bg-neutral-500 rounded">Projects &gt;</Link>
        </article>
    );
}